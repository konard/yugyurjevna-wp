...
/**
 * Общедоступная функциональность плагина.
 *
 * @link       https://almazweb.company/
 * @since      1.0.0
 *
 * @package    Almaz_Premium_Sites
 * @subpackage Almaz_Premium_Sites/public
 */
 ...
 * поставить в очередь общедоступную таблицу стилей и JavaScript.
 *
 * @package    Almaz_Premium_Sites
 * @subpackage Almaz_Premium_Sites/public
 * @author     AlmazWeb.Company <almazweb.company@mail.ru>
 */
class Almaz_Premium_Sites_Public {
	...
	/**
	 * Зарегистрируйте таблицы стилей для общедоступной части сайта.
	 *
	 * @since    1.0.0
	 */
	public function enqueue_styles() {
		...
		* сорт.
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/almaz-premium-sites-public.css', array(), $this->version, 'all' );

	}

	/**
	* Зарегистрируйте JavaScript для общедоступной части сайта.
	 *
	 * @since    1.0.0
	 */
	public function enqueue_scripts() {
		...
		*/
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/almaz-premium-sites-public.js', array( 'jquery' ), $this->version, false );
