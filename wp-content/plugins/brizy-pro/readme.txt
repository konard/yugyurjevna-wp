...
= 2.7.12 - 2025-12-15 =
* New: Posts element includes a random order option
* Fixed: RichText link popup now works correctly with dynamic text
* Fixed: Incorrect number of products or posts in preview resolved

= 2.7.11 - 2025-12-03 =
* Fixed: Richtext does not works correctly for emails

= 2.7.10 - 2025-12-01 =
* Improved: Form – improved toolbar for field editing
* Fixed: Adobe Integration – no longer crashes in the editor
* Fixed: Animated Headline – text prefix now wraps correctly

= 2.7.9 - 2025-11-10 =
* Fixed: Missing label for Search element
* Fixed: Mmenu expands submenu in panel for items without link
* Improved: Placeholder loading performance
* Improved: Popup added possibility to disable "Close Popup" action via config

= 2.7.8 - 2025-10-21 =
* New: Carousel – new arrow and dot styling options
* New: Carousel – added “order by custom field” option for dynamic content
* New: Forms – new calculable form field
* New: Posts – added “order by custom fields” option
* New: SMTP – improved remove SMTP option
* Fixed: Menu – dropdown menu no longer gets overlapped by the lower header block
* Fixed: Form – input fields no longer zoom in on iOS devices
* Fixed: Gallery – filters now work properly in Justified layout
* Fixed: Tooltip – stays within screen bounds on small viewports
* Fixed: Carousel – effects now apply correctly to the last slide

= 2.7.7 - 2025-09-30 =
* New: Global Blocks – confirmation dialog before removing items
* New: Global Blocks – improved handling when removing items
* New: Rules – removed rules are now hidden
* Fixed: Story – styles now render properly in Story mode
* Fixed: Menu – background image can now be set for responsive mode
* Fixed: Menu – submenus now expand correctly for items without links
* Fixed:  WP_Query creation for post loops
* Fixed:  PHP Deprecation warnings

= 2.7.6 - 2025-09-04 =
* New: Forms – option to set predefined default values
* New: Forms – option to display a message for empty required fields
* New: Forms – option to close a popup automatically after form submission
* New: Menu – animated hamburger icon
* Fixed: Fonts – duplicate fonts no longer appear when importing layouts in Cloud
* Fixed: Post Info – removed unnecessary spacing in preview
* Fixed: Menu – context menu works properly inside Mega Menu

= 2.7.5 - 2025-08-26 =
* New: Menu – quickly jump to a menu item directly from the toolbar
* New: Condition Choices – improved search request on filtering
* Fixed: Login – redirect URL now works correctly after logout
* Fixed: PayPal – account option title in toolbar fits properly
* Fixed: Menu – dropdown visible even with only one block on the page
* Fixed: Star Rating – custom icon background now visible
* Fixed: Video – custom video lightbox works correctly
* Fixed: Section Header – extra spacing removed in responsive editor view
