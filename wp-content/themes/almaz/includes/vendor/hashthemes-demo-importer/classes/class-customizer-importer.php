...
class HDI_Customizer_Importer {
    ...
    public static function import($customizerFile, $excludeImages) {
        ...
        if ('array' != gettype($data)) {
            $error = __('Error importing settings! Please check that you uploaded a customizer export file.', 'almaz-theme');
            return;
        }
        ...
        if ($data['template'] != $template) {
            $error = __('Error importing settings! The settings you uploaded are not for the current theme.', 'almaz-theme');
            return;
        }
